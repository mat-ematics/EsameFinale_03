...
/* Bottone di Invio */
const buttonSubmitCredentials = document.querySelectorAll(".button-submit");
...
/* Ripeti Password */
const repeatPasswordList = document.querySelectorAll(".input-repeat-password");
...
credentials.forEach(input => {
    ...
    input.addEventListener("input", function (e) {
        ...
        const errContainer = this.closest("form").querySelector(`.errors-container.${this.dataset.type}-errors`);
...
repeatPasswordList.forEach(input => {
    input.addEventListener("input", function () {
        checkPasswordMatch(this.closest("form"));
    });
});
